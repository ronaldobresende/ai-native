# market_price_researcher Agent Specification

## Purpose

Pesquisa, com client/tool mockado e fonte web configuravel, o preco aproximado do imovel e retorna estimativa, fonte, data e confianca.

## Project-Specific Contract

Uses `MockMarketPriceClient` in `tools/market_client.py`.

Inputs are `MarketPriceInput`. Outputs are `MarketPriceOutput`.

No real web request is allowed until the mock client is replaced.
