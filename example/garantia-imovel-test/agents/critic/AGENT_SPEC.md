...
Valida consistencia entre matricula, analise de penhorabilidade, preco estimado e decisao de garantia, apontando contradicoes e riscos.

## Project-Specific Contract

Inputs are `CriticInput`. Outputs are `CriticOutput`.

The critic validates consistency between registry data, lienability analysis,
market price output, and guarantee decision. It must report contradictions
without creating new business or legal rules.
