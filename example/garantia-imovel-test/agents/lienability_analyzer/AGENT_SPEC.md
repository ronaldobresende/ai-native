# lienability_analyzer Agent Specification

## Purpose

Le os dados da matricula e analisa, sem parecer juridico definitivo, se o imovel parece penhoravel, retornando conclusao, justificativa e riscos.

## Project-Specific Contract

Inputs are `LienabilityInput`. Outputs are `LienabilityOutput`.

The local judge checks that the output avoids definitive legal-opinion
language. This agent must not add real legal rules beyond the mock signals
available in the registry data.
